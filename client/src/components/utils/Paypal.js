...
export default class Paypal extends React.Component {
    render() {
        const onSuccess = (payment) => {
            ...
            // You can bind the "payment" object's value to your state 
        ...
        const onError = (err) => {
            // The main Paypal's script cannot be loaded or somethings 
            //block the loading of that script!
            console.log("Error!", err);
            // Because the Paypal's main script is loaded asynchronously 
            //from "https://www.paypalobjects.com/api/checkout.js"
            // => sometimes it may take about 0.5 second for everything 
            //to get set, or for the button to appear
        }

        let env = 'sandbox'; // you can set here to 'production' for production
        let currency = 'USD'; // or you can set this value from your props or state
        let total = this.props.toPay; // same as above, this is the total amount 
        ...
        // For sandbox app-ID (after logging into your developer account, 
        //please locate the "REST API apps" section, click "Create App"):
